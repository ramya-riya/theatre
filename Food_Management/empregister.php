...
$rdate=date("d-m-Y");
if(isset($btn)){
    $mq=mysqli_query($connect, "select max(id) from employee");
	$mr=mysqli_fetch_array($mq);
	$id=$mr['max(id)']+1;
    $i="insert into employee(id,name,mobile,email,city,username,password,rdate,latitude,longitude) values($id,'$name','$mobile','$email','$location','$username','$password','$rdate','$lat','$lon')";
