...
$rdate=date("d-m-Y");
if(isset($btn)){
    $mq=mysqli_query($connect, "select max(id) from register");
	$mr=mysqli_fetch_array($mq);
	$id=$mr['max(id)']+1;
    $i="insert into register(id,name,mobile,email,city,username,password,rdate,latitude,longitude) values($id,'$name','$mobile','$email','$location','$username','$password','$rdate','$lat','$lon')";
	...
	if($qry)
		...
		window.location.href="hotel_login.php";
		</script>
		<?php
		}
		else
                ...
                <div class="col-lg-1">
                    ...
                    <form name="form1" action="" method="post">
                                        <input type="text" class="name" name="name" placeholder="Name" required="">
                                         ...
                                         <input type="text" class="email" name="mobile" placeholder="mobile" required="">
										...
										<input type="password" class="password" name="password" placeholder="Password" required=""><br>
                                         ...
                                         <a  style="color-black" href="hotel_login.php">Login</a> 
